...
form.addEventListener('submit', function(event){
    ...
    // } else if(Array.from(ingredientsList.children).length != 0){
    //     alert('Wprowadz liste skladnikow')
    //     return false;
    // } else if(Array.from(manualList.children).length){
    //     alert('Wprowadz instrukcje')
    //     return false
    // }
